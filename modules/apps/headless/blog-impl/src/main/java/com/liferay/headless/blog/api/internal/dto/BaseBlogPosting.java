...
import com.liferay.blog.api.dto.BlogPosting;
...
public class BaseBlogPosting implements BlogPosting {
	...
	public BaseBlogPosting(
		...
		long categoryId, long commentId, long contentSpaceId,
		Date createDate, long creatorId, String description,
		String encodingFormat, String friendlyURLPath, String headline,
		long imageId, List<String> keywords, Date modifiedDate,
		Date publishedDate) {
	...
	public void setAggregateRatingId(
