 ...
 */
@Generated("")
@GraphQLName("FragmentEntryLink")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "FragmentEntryLink")
public class FragmentEntryLink {
	...
	public String toString() {
		...
		if (editableValues != null) {
			...
			sb.append(_escape(editableValues));
	...
	@Schema(
		defaultValue = "com.liferay.headless.delivery.dto.v1_0.FragmentEntryLink",
		name = "x-class-name"
	)
