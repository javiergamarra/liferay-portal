...
public interface FragmentResource {
	...
	public HttpInvoker.HttpResponse
			getFragmentCollectionFragmentsPageHttpResponse(
				Long fragmentCollectionId, Pagination pagination)
		throws Exception;

	public Fragment getFragment(Long fragmentId) throws Exception;

	public HttpInvoker.HttpResponse getFragmentHttpResponse(Long fragmentId)
		throws Exception;
	...
	public static class FragmentResourceImpl implements FragmentResource {
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-delivery/v1.0/fragment-collections/{fragmentCollectionId}/fragments",
		...
		public Fragment getFragment(Long fragmentId) throws Exception {
			HttpInvoker.HttpResponse httpResponse = getFragmentHttpResponse(
				fragmentId);
		...
		public HttpInvoker.HttpResponse getFragmentHttpResponse(Long fragmentId)
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-delivery/v1.0/fragments/{fragmentId}",
				fragmentId);
