...
public class FragmentContentFieldSerDes {
	...
	public static String toJSON(FragmentContentField fragmentContentField) {
		...
		if (fragmentContentField.getLink() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(String.valueOf(fragmentContentField.getLink()));
		}
	...
	public static Map<String, String> toMap(
		...
		if (fragmentContentField.getLink() == null) {
			...
			map.put("link", String.valueOf(fragmentContentField.getLink()));
		}
