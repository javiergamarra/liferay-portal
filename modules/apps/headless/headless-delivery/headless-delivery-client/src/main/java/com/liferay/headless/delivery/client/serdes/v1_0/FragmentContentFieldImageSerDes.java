...
public class FragmentContentFieldImageSerDes {
	...
	public static String toJSON(
		...
		if (fragmentContentFieldImage.getImage() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(String.valueOf(fragmentContentFieldImage.getImage()));
		}
	...
	public static Map<String, String> toMap(
		...
		if (fragmentContentFieldImage.getImage() == null) {
			...
			map.put(
				"image", String.valueOf(fragmentContentFieldImage.getImage()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "image")) {
				if (jsonParserFieldValue != null) {
					fragmentContentFieldImage.setImage(
