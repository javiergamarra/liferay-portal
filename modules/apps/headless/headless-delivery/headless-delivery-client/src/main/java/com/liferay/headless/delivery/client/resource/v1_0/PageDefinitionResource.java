...
public interface PageDefinitionResource {
	...
	public PageDefinition getPageTemplate(Long pageTemplateId) throws Exception;

	public HttpInvoker.HttpResponse getPageTemplateHttpResponse(
			Long pageTemplateId)
		throws Exception;
	...
	public static class PageDefinitionResourceImpl
		...
		public PageDefinition getPageTemplate(Long pageTemplateId)
			...
			HttpInvoker.HttpResponse httpResponse = getPageTemplateHttpResponse(
				pageTemplateId);
			...
			try {
				return com.liferay.headless.delivery.client.serdes.v1_0.
					PageDefinitionSerDes.toDTO(content);
			}
			catch (Exception e) {
				_logger.log(
					Level.WARNING,
		...
		public HttpInvoker.HttpResponse getPageTemplateHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-delivery/v1.0/page-templates/{pageTemplateId}",
				pageTemplateId);
