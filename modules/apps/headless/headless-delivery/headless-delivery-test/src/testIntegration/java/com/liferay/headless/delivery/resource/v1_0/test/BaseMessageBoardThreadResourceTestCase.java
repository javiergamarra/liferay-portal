...
public abstract class BaseMessageBoardThreadResourceTestCase {
	...
	protected MessageBoardThread
		...
		return messageBoardThreadResource.postSiteMessageBoardThreads(
	...
	@Test
	public void testGraphQLPostSiteMessageBoardThreads() throws Exception {
		MessageBoardThread randomMessageBoardThread =
			randomMessageBoardThread();
	...
	protected MessageBoardThread
		...
		return jsonDeserializer.deserialize(
			String.valueOf(
				dataJSONObject.getJSONObject("createSiteMessageBoardThreads")),
