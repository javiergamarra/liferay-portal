...
public abstract class BaseKnowledgeBaseFolderResourceTestCase {
	...
	protected KnowledgeBaseFolder
		...
		return knowledgeBaseFolderResource.postSiteKnowledgeBaseFolders(
	...
	@Test
	public void testGraphQLPostSiteKnowledgeBaseFolders() throws Exception {
		KnowledgeBaseFolder randomKnowledgeBaseFolder =
			randomKnowledgeBaseFolder();
	...
	protected KnowledgeBaseFolder
		...
		GraphQLField graphQLField = new GraphQLField(
			"mutation",
			new GraphQLField(
				"createSiteKnowledgeBaseFolders",
				new HashMap<String, Object>() {
					{
						put("siteId", testGroup.getGroupId());
		...
		return jsonDeserializer.deserialize(
			String.valueOf(
				dataJSONObject.getJSONObject("createSiteKnowledgeBaseFolders")),
