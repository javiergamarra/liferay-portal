...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "For Java, you can use com.liferay.headless.admin.workflow.client, version 2.0.1", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "Headless Admin Workflow", version = "v1.0")
)
@Path("/v1.0")
