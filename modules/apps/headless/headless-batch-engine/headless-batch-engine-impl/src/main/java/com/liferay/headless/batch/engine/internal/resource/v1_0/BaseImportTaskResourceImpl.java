...
public abstract class BaseImportTaskResourceImpl implements ImportTaskResource {
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/headless-batch-engine/v1.0/import-task/{importTaskId}/'  -u 'test@liferay.com:test'
	 */
	@Override
	 ...
	 * Invoke this method with the command line:
	 *
	 * curl -X 'PUT' 'http://localhost:8080/o/headless-batch-engine/v1.0/import-task/{importTaskId}/'  -u 'test@liferay.com:test'
	 */
	@Override
	@Consumes("multipart/form-data")
