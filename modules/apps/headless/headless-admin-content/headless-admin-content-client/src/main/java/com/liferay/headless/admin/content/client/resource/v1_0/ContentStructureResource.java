...
public interface ContentStructureResource {
	...
	public HttpInvoker.HttpResponse
			postAssetLibraryContentStructureHttpResponse(
				Long siteId, ContentStructure contentStructure)
		throws Exception;
	...
	public HttpInvoker.HttpResponse deleteContentStructureHttpResponse(
	...
	public HttpInvoker.HttpResponse patchContentStructureHttpResponse(
			Long contentStructureId, ContentStructure contentStructure)
		throws Exception;
	...
	public HttpInvoker.HttpResponse putContentStructureHttpResponse(
			Long contentStructureId, ContentStructure contentStructure)
		throws Exception;
	...
	public HttpInvoker.HttpResponse postSiteContentStructureHttpResponse(
			Long siteId, ContentStructure contentStructure)
		throws Exception;
	...
	public static class ContentStructureResourceImpl
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-admin-content/v1.0/asset-libraries/{assetLibraryId}/content-structures");
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.body(contentStructure.toString(), "application/json");
		...
		public void deleteContentStructure(Long contentStructureId)
			...
			HttpInvoker.HttpResponse httpResponse =
				deleteContentStructureHttpResponse(contentStructureId);
		...
		public HttpInvoker.HttpResponse deleteContentStructureHttpResponse(
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-admin-content/v1.0/content-structures/{contentStructureId}");
		...
		public ContentStructure patchContentStructure(
			...
			HttpInvoker.HttpResponse httpResponse =
				patchContentStructureHttpResponse(
		...
		public ContentStructure putContentStructure(
			...
			HttpInvoker.HttpResponse httpResponse =
				putContentStructureHttpResponse(
					contentStructureId, contentStructure);
		...
		public HttpInvoker.HttpResponse
			...
			httpInvoker.path(
				_builder._scheme + "://" + _builder._host + ":" +
					_builder._port +
						"/o/headless-admin-content/v1.0/sites/{siteId}/content-structures");
		...
		public ContentStructure postSiteContentStructure(
			...
			HttpInvoker.HttpResponse httpResponse =
				postSiteContentStructureHttpResponse(siteId, contentStructure);
