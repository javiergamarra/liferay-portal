...
import com.liferay.headless.admin.content.client.dto.v1_0.ContentStructure;
...
import com.liferay.headless.admin.content.client.resource.v1_0.ContentStructureResource;
import com.liferay.headless.admin.content.client.serdes.v1_0.ContentStructureSerDes;
...
public abstract class BaseContentStructureResourceTestCase {
	...
	public void testGetAssetLibraryContentStructuresPage() throws Exception {
		...
		contentStructureResource.deleteContentStructure(
			contentStructure1.getId());

		contentStructureResource.deleteContentStructure(
			contentStructure2.getId());
	}
	...
	protected ContentStructure
		...
		return contentStructureResource.postAssetLibraryContentStructure(
			assetLibraryId, contentStructure);
	}
	...
	@Test
	public void testPostAssetLibraryContentStructure() throws Exception {
		ContentStructure randomContentStructure = randomContentStructure();

		ContentStructure postContentStructure =
			testPostAssetLibraryContentStructure_addContentStructure(
				randomContentStructure);

		assertEquals(randomContentStructure, postContentStructure);
		assertValid(postContentStructure);
	}
	...
	@Test
	public void testDeleteContentStructure() throws Exception {
		@SuppressWarnings("PMD.UnusedLocalVariable")
		ContentStructure contentStructure =
			testDeleteContentStructure_addContentStructure();

		assertHttpResponseStatusCode(
			204,
			contentStructureResource.deleteContentStructureHttpResponse(
				contentStructure.getId()));

		assertHttpResponseStatusCode(
			404,
			contentStructureResource.getContentStructureHttpResponse(
				contentStructure.getId()));

		assertHttpResponseStatusCode(
			404, contentStructureResource.getContentStructureHttpResponse(0L));
	}

	protected ContentStructure testDeleteContentStructure_addContentStructure()
		throws Exception {

		return contentStructureResource.postSiteContentStructure(
			testGroup.getGroupId(), randomContentStructure());
	}

	@Test
	public void testGraphQLDeleteContentStructure() throws Exception {
		ContentStructure contentStructure =
		...
		Assert.assertTrue(
			JSONUtil.getValueAsBoolean(
				...
				"JSONObject/data", "Object/deleteContentStructure"));
	...
	@Test
	public void testPatchContentStructure() throws Exception {
		ContentStructure postContentStructure =
			testPatchContentStructure_addContentStructure();

		ContentStructure randomPatchContentStructure =
			randomPatchContentStructure();

		@SuppressWarnings("PMD.UnusedLocalVariable")
		ContentStructure patchContentStructure =
			contentStructureResource.patchContentStructure(
				postContentStructure.getId(), randomPatchContentStructure);

		ContentStructure expectedPatchContentStructure =
			postContentStructure.clone();

		_beanUtilsBean.copyProperties(
			expectedPatchContentStructure, randomPatchContentStructure);

		ContentStructure getContentStructure =
			contentStructureResource.getContentStructure(
				patchContentStructure.getId());

		assertEquals(expectedPatchContentStructure, getContentStructure);
		assertValid(getContentStructure);
	}

	protected ContentStructure testPatchContentStructure_addContentStructure()
		throws Exception {
	...
	@Test
	public void testPutContentStructure() throws Exception {
		ContentStructure postContentStructure =
			testPutContentStructure_addContentStructure();

		ContentStructure randomContentStructure = randomContentStructure();

		ContentStructure putContentStructure =
			contentStructureResource.putContentStructure(
				postContentStructure.getId(), randomContentStructure);

		assertEquals(randomContentStructure, putContentStructure);
		assertValid(putContentStructure);

		ContentStructure getContentStructure =
			contentStructureResource.getContentStructure(
				putContentStructure.getId());

		assertEquals(randomContentStructure, getContentStructure);
		assertValid(getContentStructure);
	}

	protected ContentStructure testPutContentStructure_addContentStructure()
		throws Exception {
	...
	@Test
	public void testPostSiteContentStructure() throws Exception {
		ContentStructure randomContentStructure = randomContentStructure();

		ContentStructure postContentStructure =
			testPostSiteContentStructure_addContentStructure(
				randomContentStructure);
	...
	protected ContentStructure testPostSiteContentStructure_addContentStructure(
			ContentStructure contentStructure)
		throws Exception {

		return contentStructureResource.postSiteContentStructure(
			testGetSiteContentStructuresPage_getSiteId(), contentStructure);
	}

	@Test
	public void testGraphQLPostSiteContentStructure() throws Exception {
		ContentStructure randomContentStructure = randomContentStructure();
		...
		Assert.assertTrue(equals(randomContentStructure, contentStructure));
	}
	...
	protected ContentStructure testGraphQLContentStructure_addContentStructure(
		...
		JSONDeserializer<ContentStructure> jsonDeserializer =
			JSONFactoryUtil.createJSONDeserializer();

		StringBuilder sb = new StringBuilder("{");

		for (Field field : getDeclaredFields(ContentStructure.class)) {
			...
			appendGraphQLFieldValue(sb, field.get(contentStructure));
		}
						...
						new HashMap<String, Object>() {
							{
								...
								put("contentStructure", sb.toString());
							}
						},
						graphQLFields)),
				"JSONObject/data", "JSONObject/createSiteContentStructure"),
	...
	private
		com.liferay.headless.admin.content.resource.v1_0.
			ContentStructureResource _contentStructureResource;
