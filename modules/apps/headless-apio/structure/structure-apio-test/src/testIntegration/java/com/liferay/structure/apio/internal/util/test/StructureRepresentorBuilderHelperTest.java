...
public class StructureRepresentorBuilderHelperTest {
	...
	public void testBooleanFieldDataType() throws Exception {
		DDMFormField ddmFormFieldValue = new DDMFormField(
			"MyBoolean", "checkbox");

		ddmFormFieldValue.setDataType("boolean");

		String dataType = _getDDMFormFieldDataType(ddmFormFieldValue);
	...
	public void testBooleanFieldInputControl() throws Exception {
		...
		String inputControl = _getDDMFormFieldInputControl(ddmFormFieldValue);
