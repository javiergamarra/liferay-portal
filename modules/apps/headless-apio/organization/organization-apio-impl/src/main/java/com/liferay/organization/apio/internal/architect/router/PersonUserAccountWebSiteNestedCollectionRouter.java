 ...
 * href="http://schema.org/Organization">Organization</a> resources contained inside a <a
 * href="http://schema.org/Person">Person</a> through a web API. The resources
 * are mapped from the internal model {@link Organization}.
 *
 * @author Eduardo Perez
 * @review
 */
@Component(immediate = true)
public class PersonUserAccountWebSiteNestedCollectionRouter extends
