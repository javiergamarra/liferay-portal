...
import com.liferay.account.rest.client.dto.v1_0.EmailAddress;
import com.liferay.account.rest.client.dto.v1_0.Phone;
import com.liferay.account.rest.client.dto.v1_0.PostalAddress;
import com.liferay.account.rest.client.dto.v1_0.UserAccountContactInformation;
import com.liferay.account.rest.client.dto.v1_0.WebUrl;
	...
	public static String toJSON(
		...
		if (userAccountContactInformation.getEmailAddresses() != null) {
			...
			for (int i = 0;
				...
				sb.append(userAccountContactInformation.getEmailAddresses()[i]);
		...
		if (userAccountContactInformation.getTelephones() != null) {
			...
			for (int i = 0;
				...
				sb.append(userAccountContactInformation.getTelephones()[i]);
		...
		if (userAccountContactInformation.getWebUrls() != null) {
			...
			for (int i = 0;
				...
				sb.append(userAccountContactInformation.getWebUrls()[i]);
