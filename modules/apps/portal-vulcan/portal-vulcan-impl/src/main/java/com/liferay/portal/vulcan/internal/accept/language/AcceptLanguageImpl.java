...
public class AcceptLanguageImpl implements AcceptLanguage {
	...
	public static final boolean ACCEPT_ALL_LANGUAGES_DEFAULT_VALUE = false;

	public static final String ACCEPT_ALL_LANGUAGES_HEADER =
	...
	public boolean isAcceptAllLanguages() {
		return GetterUtil.getBoolean(
			_httpServletRequest.getHeader(ACCEPT_ALL_LANGUAGES_HEADER),
			ACCEPT_ALL_LANGUAGES_DEFAULT_VALUE);
	}
