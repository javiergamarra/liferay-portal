...
public class ActionUtil {
	...
	public static Map<String, String> addAction(
		...
		return addAction(
			...
			groupedModel.getUserId(), groupedModel.getGroupId(), uriInfo);
	}

	public static Map<String, String> addAction(
		String actionName, Class clazz, Long id, String methodName,
		String permissionName, Object object, Long ownerId, Long siteId,
		UriInfo uriInfo) {

		try {
			return _addAction(
				actionName, clazz, id, methodName, permissionName, object,
				ownerId, siteId, uriInfo);
		}
	...
	public static Map<String, String> addAction(
		...
		return addAction(
			actionName, clazz, id, methodName, permissionName, object, null,
			siteId, uriInfo);
	}
